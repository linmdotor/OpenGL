...
/**
 Clase Panel, que construye uno de los paneles del satelite.
*/
...
public:
	Panel()
	{
		...
		GLdouble ancho = radio_satelite-(radio_satelite/3);
		GLdouble largo = 5*radio_satelite;
		GLdouble alto = radio_satelite/4;

		_vertice[0] = new PV3D(-ancho, -alto , radio_satelite/1.5, true);
		_vertice[1] = new PV3D(ancho, -alto , radio_satelite/1.5, true);
		_vertice[2] = new PV3D(ancho, -alto , largo, true);
		_vertice[3] = new PV3D(-ancho, -alto , largo, true);

		_vertice[4] = new PV3D(-ancho, 0.0 , radio_satelite/1.5, true);
		_vertice[5] = new PV3D(ancho, 0.0 , radio_satelite/1.5, true);
		_vertice[6] = new PV3D(ancho, 0.0 , largo, true);
		_vertice[7] = new PV3D(-ancho, 0.0 , largo, true);
